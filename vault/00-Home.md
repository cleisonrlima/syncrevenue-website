...
- Active phase: **Epic 4 (Phase 3)** — Story 4.1 (admin auth) done 2026-05-16. Story 4.2 (leads dashboard) → review 2026-05-16. Next: cross-model review of 4.2, then Story 4.3+ + the two follow-up stories (4.7 login throttling, 4.8 JWT revocation). Epic 3 done (3.1–3.11) including retrospective.
