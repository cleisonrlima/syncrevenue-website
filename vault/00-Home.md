...
- Active phase: **Epic 4 (Phase 3)** — Story 4.1 done 2026-05-16. Story 4.2 done 2026-05-16. Story 4.7 done 2026-05-16. Story 4.8 done 2026-05-17. **Story 4.3 (lead status management) review 2026-05-17 — PATCH `/api/admin/leads/:id/status` + inline `<select>` with optimistic update + revert + per-row `role="alert"`; 473/473 tests pass; cross-model review pending.** Next: 4.4+. Epic 3 done (3.1–3.11) including retrospective.
