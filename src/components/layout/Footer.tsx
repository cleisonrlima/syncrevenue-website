      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8">
          ...
          <nav aria-label="Footer navigation" className="flex flex-col gap-2">
            ...
            <a href="#contato" className="text-sm hover:text-white transition-colors">{t('landing.footer.contact', { defaultValue: 'Contact Support' })}</a>
            <Link to="/privacy" className="text-sm hover:text-white transition-colors">{t('nav.privacy', { defaultValue: 'Privacy Policy' })}</Link>
            <Link to="/privacy#terms" className="text-sm hover:text-white transition-colors">{t('landing.footer.terms', { defaultValue: 'Terms of Service' })}</Link>
          </nav>
