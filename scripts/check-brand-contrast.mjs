...
// Surfaces are the three background tokens used in production for text-bearing surfaces.
...
// R-NT1: structural non-text pairs (surface-on-surface or accent-on-inverse).
const WAIVERS = {
